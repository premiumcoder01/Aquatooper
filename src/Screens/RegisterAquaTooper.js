import { StyleSheet, Text, View, ImageBackground, ScrollView, TextInput, Image, TouchableOpacity, Alert } from 'react-native'
...
const RegisterAquaTooper = () => {
    ...
    const Register = async () => {
        ...
        axios.post(`${AQUATOOPER_BASE_URL}`, {
    ...
    return (
        <View style={styles.container}>
            ...
            <ImageBackground source={require('../images/background.png')} resizeMode="cover" style={styles.image}>
                <ScrollView>
                    <LinearGradient colors={['#4ac6cf', '#84d7de', '#a9e1e6', '#bbe5ea', '#bbe6eb', '#bbe6eb', '#bbe6eb', '#bbe6eb']} style={styles.mainContainer}>
                        <Text style={{ textAlign: "center", color: "#fff", marginTop: 40, fontSize: 16, fontFamily: "Lato", fontWeight: 700, }}>Register Your Aqua topper</Text>
                        <Text style={{ color: "#0A4B87", marginTop: 10, fontSize: 10, lineHeight: 16, fontFamily: "Lato", fontWeight: 100, }}>
                            Here  you will register both your level sensor and hose pipe valve using thE  3-word serial found  as a small  sticker
                            affixed to the outside of each  device
                        </Text>
                        <Text style={{ color: "#0A4B87", marginTop: 30, fontSize: 14, marginLeft: 20, fontFamily: "Lato", fontWeight: 600, }}>Level Sensor 3-World Serial</Text>
                        <TextInput
                        ...
                        />
                        <Text style={{ color: "#0A4B87", marginTop: 20, fontSize: 14, marginLeft: 20, fontFamily: "Lato", fontWeight: 600, }}>Hose Pipe Valve 3-World Serial</Text>
                        <TextInput
                            placeholder='First World:'
                            style={styles.loginInput}
                            placeholderTextColor="grey"
                        ...
                        />
                        <Text style={{ color: "#0A4B87", marginTop: 0, fontSize: 10, marginLeft: 20, fontFamily: "Lato", fontWeight: 100, }}>Please customize your kit by giving it a name and a  description</Text>
                        <Text style={{ color: "#0A4B87", marginTop: 20, fontSize: 14, marginLeft: 20, fontFamily: "Lato", fontWeight: 600, }}>Name</Text>
                        <TextInput
                            placeholder='Name:'
                            style={styles.loginInput}
                            placeholderTextColor="grey"
                        ...
                        <View style={{ display: "flex", flexDirection: "row", marginLeft: 13, }}>
                            <Image source={require('../images/information.png')} style={{ marginTop: 6, }} />
                            <Text style={{ color: "#0A4B87", marginTop: 0, fontSize: 10, marginLeft: 6, fontFamily: "Lato", fontWeight: 100, }}>Remember to set the open/close values on the
                                Aqua Topper kit’s page</Text>
                        </View>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Text style={{
                                color: "#083258", textAlign: "center", fontSize: 12, marginTop: 30, paddingBottom: 30,
                                textDecorationLine: "underline",
                                textDecorationStyle: "solid",
                                textDecorationColor: "#083258",
                            }}>How we use your data?</Text>
                        </TouchableOpacity>
