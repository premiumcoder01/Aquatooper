...
const Email = () => {
    ...
    const forgetUserEmail = (password) => {
        setIsLoading(true)

        axios.post(`${BASE_URL}/resend-email-confirmation`, {
            email,
        ...
        <View style={styles.container}>
            ...
            <ImageBackground source={require('../images/background.png')} resizeMode="cover" style={styles.image}>
                <LinearGradient colors={['#5dcbd3', '#9edce2', '#9edce2', '#9edce2', '#fff']} style={styles.firstView}>
                    <Text style={{ color: "#fff", textAlign: "center", marginTop: 180, fontSize: 18, marginBottom: 30, fontFamily: "Lato", fontWeight: 700, }}>Resent Email Verification</Text>
