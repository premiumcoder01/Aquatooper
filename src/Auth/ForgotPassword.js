...
const ForgotPassword = () => {
    ...
    const forgetUserPassword = (password) => {
        setIsLoading(true)
        ...
        <View style={styles.container}>
            ...
            <ImageBackground source={require('../images/background.png')} resizeMode="cover" style={styles.image}>
                <LinearGradient colors={['#5dcbd3', '#9edce2', '#9edce2', '#9edce2', '#fff']} style={styles.firstView}>
                    <Text style={{ color: "#fff", textAlign: "center", marginTop: 180, fontSize: 18, marginBottom: 30, fontFamily: "Lato", fontWeight: 700, }}>Forgot you’re password </Text>
                    ...
                    >
                        <Text style={{ textAlign: "center", color: "#fff" }}>Resent Password </Text>
                    </TouchableOpacity>
                    ...
                    >
                        <Text style={{
                            color: "#083258", textAlign: "center", fontSize: 12, marginTop: 90,
                    ...
                    >
                        <Text style={{
                            color: "#083258", textAlign: "center", fontSize: 12, marginTop: 10,
                            textDecorationLine: "underline",
                            textDecorationStyle: "solid",
                            textDecorationColor: "#083258",
