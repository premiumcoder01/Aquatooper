        ...
        <View style={styles.container}>
            <ImageBackground source={require('../images/background.png')} resizeMode="cover" style={styles.image}>
                <LinearGradient colors={['#5dcbd3', '#9edce2', '#9edce2', '#9edce2', '#fff']} style={styles.firstView}>
                    <Text style={{ color: "#fff", textAlign: "center", marginTop: 180, fontSize: 18, marginBottom: 30, fontFamily: "Lato", fontWeight: 700, }}>Register Confirmation   </Text>
                    <Text style={{ color: "#fff", textAlign: "center", fontSize: 12, marginBottom: 20, }}>Please check you're e-mail to confirm you're account</Text>
